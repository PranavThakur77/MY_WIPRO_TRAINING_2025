...
function seeMyPage(){
    document.getElementById("jsdemo").innerText="This is my js demo page";
...
maindiv.getElementsByTagName("h2")[0].textContent="Tap to see changes in text";
function changeContent(){
    maindiv.getElementsByTagName("h2")[0].textContent="The Button is clicked";
}
